...
const STRINGS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    intro3: "We are Indonesia's mood tracker and AI therapist.",
  ...
  id: {
    ...
    intro3: 'Kami adalah pelacak mood & AI “terapis” Indonesia.',
  ...
  return (
    <>
      ...
      <div className="fixed right-4 top-4 z-40">
        <Button size="sm" variant="outline" className="flex items-center gap-2" onClick={() => setLang(lang === 'id' ? 'en' : 'id')}>
                ...
                <TabsContent value="login" className="space-y-4 mt-6">
                  <form onSubmit={handleSignIn} className="space-y-4">
                    ...
                    <div className="flex justify-end">
                      <Link to="/auth/forgot-password" className="text-sm text-primary hover:text-primary/80 hover:underline">
                        {t('forgot')}
                      </Link>
                    </div>
